...
#TCP_OUT = "20,21,22,25,53,80,110,113,443,993,995"
TCP_OUT = "80"
...
#
# Not supported:
# CC_DENY, CC_ALLOW, CC_ALLOW_FILTER, SYNFLOOD, PORTFLOOD,
...
# Allow outgoing TCP ports
TCP6_OUT = "20,21,22,25,53,80,110,113,443,993,995"
...
#
# ipset will only be used with the above options when listing IPv4 IPs and
# CIDRs. IPv6 IPs, Advanced Allow Filters and temporary blocks use traditional
# iptables
#
